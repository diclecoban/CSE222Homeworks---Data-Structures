...
/**
 * A class to visualize performance graphs using Swing GUI components.
 * This class extends JFrame to create a window for displaying the graphs.
 */
public class GUIVisualization extends JFrame {
    ...
    /**
     * List to store y-axis data points.
     */
    ...
    /**
     * Constructs a GUIVisualization object with the specified plot type, x-axis data points,
     * and y-axis data points.
     *
    ...
    public GUIVisualization(String plotType, List<Integer> dataPointsX, List<Long> dataPointsY) {
        ...
        this.dataPointsX = dataPointsX; // Set the x-axis data points
        this.dataPointsY = dataPointsY; // Set the y-axis data points
    ...
    /**
     * Draws the graph based on the specified data points.
     *
     * @param g The Graphics object used for drawing.
     */
    ...
    /**
     * Finds the maximum y-axis value among the data points.
     *
